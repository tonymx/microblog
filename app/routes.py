...
from app import db
from app.forms import RegistrationForm,EditProfileForm,EmptyForm,PostForm,ResetPasswordRequestForm
...
def index():
    ...
    #el caracter \ solo esta indicando que el código continua en la siguiente linea
